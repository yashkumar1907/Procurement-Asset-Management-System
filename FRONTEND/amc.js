...
function getCurrentPermission() {
    return localStorage.getItem("amcPermission") || "none";
}
...
async function loadRecords() {
    try {
        const response = await fetch(`${API_BASE_URL}/api/amc-records`);
...
async function loadReferencePOs() {
    ...
    try {
        const response = await fetch(
            `${API_BASE_URL}/api/amc-records/reference-pos`
        );
    ...
    try {
        ...
        if (editingRecordId) {
            ...
            response = await fetch(
                `${API_BASE_URL}/api/amc-records/${editingRecordId}`,
                {
                    method: "PUT",
                    body: formData
                }
...
async function deleteRecord(id) {
    ...
    try {
        const response =
            await fetch(
                `${API_BASE_URL}/api/amc-records/${id}`,
                {
                    method: "DELETE"
                }
            );
...
async function editDetail(id) {
    ...
    try {
        const response = await fetch(`${API_BASE_URL}/api/amc-details/single/${id}`);
...
async function deleteDetail(id) {
    ...
    try {
        const response =
            await fetch(
                `${API_BASE_URL}/api/amc-details/${id}`,
                {
                    method: "DELETE",
                    headers: {
...
async function loadDetails(recordId) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/amc-details/${recordId}`);
...
function exportExcel() {
    window.open(`${API_BASE_URL}/api/amc-records/export`, "_blank");
}
...
async function importExcel(input) {
    ...
    try {
        const response =
            await fetch(
                `${API_BASE_URL}/api/amc-records/import`,
                {
                    method: "POST",
                    body: formData
                }
